...
class Rave extends PaymentModule
{
    ...
    protected function _postProcess()
    {
        if (Tools::isSubmit('btnSubmit')) {
            ...
            Configuration::updateValue('RAVE_MERCHANT_DESCRIPTION', Tools::getValue('RAVE_MERCHANT_DESCRIPTION'));
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->trans('Modal Description', array(), 'Modules.Rave.Admin'),
                        'name' => 'RAVE_MERCHANT_DESCRIPTION',
                        'required' => false
                    ),
                    array(
                        'type' => 'text',
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'RAVE_MERCHANT_DESCRIPTION' => Tools::getValue('RAVE_MERCHANT_DESCRIPTION', Configuration::get('RAVE_MERCHANT_DESCRIPTION')),
